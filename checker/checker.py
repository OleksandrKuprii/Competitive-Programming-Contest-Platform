from dataclass.ResultToChecker import ResultToChecker
...
def check_result(test_results, correct_results, submission_id):
    ...
    for test_result, correct in zip(test_results, correct_results):
        ...
        prepare_result = ResultToDB(submission_id, test_id, status, points, wall_time, cpu_time)
...
if __name__ == '__main__':
    a = ResultToChecker(1, [TestResult(10, 'C', '1000000000', 0.124, 0.002),
                            TestResult(10, 'TL', '', 0.124, 0.002)])
    get_result(a)
