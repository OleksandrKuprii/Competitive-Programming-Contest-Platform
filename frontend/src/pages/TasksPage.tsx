...
import Difficulty from '../components/atoms/difficulty';
import SmallRatingChart from '../components/molecules/smallRatingChart';
...
import { HorizontalSpacer, Spacer } from '../components/atoms/spacers';
