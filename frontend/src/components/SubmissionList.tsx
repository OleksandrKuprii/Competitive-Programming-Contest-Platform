...
function SubmissionPage(props: { submissions: Submission[] }) {
        ...
        <Table striped hover variant="dark" size='sm' borderless>
            ...
            {props.submissions.map((submission, i) =>
                    <tr key={i}>
                        ...
                        <td>
                          <StatusColor status = {submission.status} points = {submission.points}></StatusColor>
                        </td> 
                        <td>
                            <Points points = {submission.points} ></Points>
                        </td>
