...
const TaskRatingHistogram = ({ id, rating }: { id: any; rating: TaskRating }) => (
  <div style={{ height: 25, padding: 3 }}>
    {[
      ...
      {
        value: rating.partiallyCorrect,
        color: 'yellow',
        tooltipInfo: '0 < x < 100 points',
      },
      { value: rating.zeroPointAnswer, color: 'red', tooltipInfo: '0 points' },
    ].map(({ value, color, tooltipInfo }) => (
      <OverlayTrigger
