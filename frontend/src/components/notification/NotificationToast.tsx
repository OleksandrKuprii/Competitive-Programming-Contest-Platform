...
const notificationBodyBuilders = {
  ...
  submitted: (notification: { id: number, type: 'submitted', submissionId: string }) => (
    <SubmissionLink id={notification.submissionId}>
      #
      {notification.submissionId}
    </SubmissionLink>
  ),
  receivedResults: (notification: { id: number, type: 'receivedResults', submissionId: string, points: number, status: string[] }) => (
    <SubmissionLink id={notification.submissionId}>
